...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, open url: URL, sourceApplication: String?, annotation: Any) -> Bool {
        DispatchQueue.main.async {
            ...
            if (url.scheme == "exampleshoppingapp"){
                self.showAlert(title: "URL scheme detected", message: "URL Scheme is exampleshoppingapp")
            ...
            if (url.scheme == "exampleshoppingapp-adyen"){
                self.showAlert(title: "URL scheme detected", message: "URL Scheme is exampleshoppingapp-adyen")
                if let viewController = self.window?.rootViewController as? ShoppingCartViewController {
                    viewController.applicationDidReceive(url)
                }
            }
